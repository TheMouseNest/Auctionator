...
function addonTable.Scanning.Legacy.QueryAllMixin:InitiateScan()
  if self:CanInitiate() then
    ...
    addonTable.Utilities.Message(addonTable.Locales.STARTING_FULL_SCAN)
...
function addonTable.Scanning.Legacy.QueryAllMixin:NextScanMessage()
  ...
  return addonTable.Locales.NEXT_SCAN_MESSAGE:format(minutesUntilNextScan, secondsUntilNextScan)
end
    ...
    elseif not link then
      ...
      item:ContinueOnItemLoad((function(index)
        return function()
          ...
          local dbKeys = addonTable.Storage.DBKeyFromLinkFast(link)
  ...
  elseif event =="AUCTION_HOUSE_CLOSED" then
    ...
    if self.inProgress then
      ...
      addonTable.Utilities.Message(
        addonTable.Locales.FULL_SCAN_FAILED .. " " .. self:NextScanMessage()
      )
...
local function MergeInfo(scanData, dbKeysMapping)
  ...
  for index = 1, #scanData do
    ...
    -- available > 0 check just in case Blizzard returns 0 available
